...
<model ref="r:9d2755d4-610b-457b-bac7-67bb74541b8d(com.mbeddr.platform.interpreter.truffle.typesystem)">
  ...
  <node concept="1YbPZF" id="rSaJgNaxPU">
    <property role="TrG5h" value="typeof_ContextExpression" />
    <property role="3GE5qa" value="expression" />
    <node concept="3clFbS" id="rSaJgNaxPV" role="18ibNy">
      <node concept="1Z5TYs" id="rSaJgNayUT" role="3cqZAp">
        <node concept="mw_s8" id="rSaJgNazcP" role="1ZfhKB">
          <node concept="2pJPEk" id="rSaJgNazcL" role="mwGJk">
            <node concept="2pJPED" id="rSaJgNazuC" role="2pJPEn">
              <ref role="2pJxaS" to="tpee:g7uibYu" resolve="ClassifierType" />
              <node concept="2pIpSj" id="rSaJgNazLB" role="2pJxcM">
                <ref role="2pIpSl" to="tpee:g7uigIF" resolve="classifier" />
                <node concept="36bGnv" id="rSaJgNa_l4" role="2pJxcZ">
                  <ref role="36bGnp" to="smiq:6I2sTc78GV9" resolve="BaseTruffleInterpreterContext" />
                </node>
              </node>
            </node>
          </node>
        </node>
        <node concept="mw_s8" id="rSaJgNayUW" role="1ZfhK$">
          <node concept="1Z2H0r" id="rSaJgNaygt" role="mwGJk">
            <node concept="1YBJjd" id="rSaJgNayr1" role="1Z2MuG">
              <ref role="1YBMHb" node="rSaJgNaxPX" resolve="contextExpression" />
            </node>
          </node>
        </node>
      </node>
    </node>
    <node concept="1YaCAy" id="rSaJgNaxPX" role="1YuTPh">
      <property role="TrG5h" value="contextExpression" />
      <ref role="1YaFvo" to="9j3q:rSaJgNauVX" resolve="ContextExpression" />
    </node>
  </node>
  <node concept="1YbPZF" id="rSaJgNeOk8">
    <property role="TrG5h" value="typeof_ObjectExpression" />
    <property role="3GE5qa" value="expression" />
    <node concept="3clFbS" id="rSaJgNeOk9" role="18ibNy">
      <node concept="1Z5TYs" id="rSaJgNePpu" role="3cqZAp">
        <node concept="mw_s8" id="rSaJgNflbI" role="1ZfhKB">
          <node concept="2pJPEk" id="rSaJgNflbq" role="mwGJk">
            <node concept="2pJPED" id="rSaJgNflkH" role="2pJPEn">
              <ref role="2pJxaS" to="tpee:g7uibYu" resolve="ClassifierType" />
              <node concept="2pIpSj" id="rSaJgNfmHw" role="2pJxcM">
                <ref role="2pIpSl" to="tpee:g7uigIF" resolve="classifier" />
                <node concept="36bGnv" id="rSaJgNfmZR" role="2pJxcZ">
                  <ref role="36bGnp" to="sw0k:~DynamicObject" resolve="DynamicObject" />
                </node>
              </node>
            </node>
          </node>
        </node>
        <node concept="mw_s8" id="rSaJgNePpx" role="1ZfhK$">
          <node concept="1Z2H0r" id="rSaJgNeOJ2" role="mwGJk">
            <node concept="1YBJjd" id="rSaJgNeOTA" role="1Z2MuG">
              <ref role="1YBMHb" node="rSaJgNeOkb" resolve="objectExpression" />
            </node>
          </node>
        </node>
      </node>
    </node>
    <node concept="1YaCAy" id="rSaJgNeOkb" role="1YuTPh">
      <property role="TrG5h" value="objectExpression" />
      <ref role="1YaFvo" to="9j3q:rSaJgNeJRZ" resolve="ObjectExpression" />
    </node>
  </node>
  <node concept="1YbPZF" id="rSaJgNm4AV">
    <property role="TrG5h" value="typeof_PropertyAccessExpression" />
    <property role="3GE5qa" value="expression" />
    <node concept="3clFbS" id="rSaJgNm4AW" role="18ibNy">
        ...
        <node concept="3cpWsn" id="hdgWYul" role="3cpWs9">
          ...
          <node concept="2OqwBi" id="hx2FveC" role="33vP2m">
            <node concept="2OqwBi" id="hx2Fv8$" role="2Oq$k0">
              <node concept="1YBJjd" id="rSaJgNmEI8" role="2Oq$k0">
                <ref role="1YBMHb" node="rSaJgNm4AY" resolve="propertyAccessExpression" />
              </node>
              <node concept="3TrEf2" id="rSaJgNmF8D" role="2OqNvi">
                <ref role="3Tt5mk" to="9j3q:rSaJgNlItv" resolve="property" />
              </node>
            </node>
            <node concept="3TrEf2" id="rSaJgNmFDp" role="2OqNvi">
          ...
          <node concept="1Z5TYs" id="hx2PeaA" role="3cqZAp">
            <node concept="mw_s8" id="hx2PeaB" role="1ZfhK$">
              <node concept="1Z2H0r" id="hx2PeaC" role="mwGJk">
                <node concept="1YBJjd" id="rSaJgNmGwC" role="1Z2MuG">
                  <ref role="1YBMHb" node="rSaJgNm4AY" resolve="propertyAccessExpression" />
                </node>
              </node>
            </node>
    ...
    <node concept="1YaCAy" id="rSaJgNm4AY" role="1YuTPh">
      <property role="TrG5h" value="propertyAccessExpression" />
      <ref role="1YaFvo" to="9j3q:rSaJgNlFGn" resolve="PropertyAccessExpression" />
    </node>
  </node>
</model>
